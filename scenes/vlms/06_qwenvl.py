...
class QwenVLScene(Scene):
    def construct(self):
        ...
        adapter = sized_box("adaptador\n(cross-attn,\n256 tokens)", font_size=16, color=WHITE, box_color=MECHANISM, box_opacity=0.45, min_width=2.4, min_height=1.5, line_spacing=1.1)
        ...
        coords = Text("(120, 80, 230, 190)", font_size=16, color=OUTPUT, font="Fira Code")
