...
class CLIPScene(Scene):
    def construct(self):
        ...
        cats = VGroup(*[
            sized_box(c, font_size=16, color=OLD, box_color=OLD, box_opacity=0.15, min_width=1.5, min_height=0.5)
        ...
        old_scale = sized_box("ImageNet\n1,28 milhão de imagens\n1000 categorias fixas", font_size=16, color=WHITE, box_color=OLD, box_opacity=0.2, min_width=4.4, min_height=1.6, line_spacing=1.25)
        new_scale = sized_box("CLIP\n400 milhões de pares\nnenhuma categoria fixa", font_size=16, color=WHITE, box_color=MECHANISM, box_opacity=0.35, min_width=4.4, min_height=1.6, line_spacing=1.25)
        ...
        space_label = Text("espaço de embeddings\ncompartilhado", font_size=16, color=MECHANISM, line_spacing=1.1)
